...
def can_play_exploration(handler):
    ...
    def test_can_play(self, exploration_id, **kwargs):
        """Check whether the exploration can be played.
        ...
        Raises:
            PageNotFoundException: The exploration page is not found.
        """
...
def can_play_collection(handler):
    ...
    def test_can_play(self, collection_id, **kwargs):
        """Check whether the collection can be played.
        ...
        Returns:
            bool. Whether the collection can be accessed
                and able to be played. If that's not the
                case them False.

        Raises:
            PageNotFoundException: The Collection page is not found.
        """
...
def can_download_exploration(handler):
    ...
    def test_can_download(self, exploration_id, **kwargs):
        """Check whether user can download exploration.

        Args:
            exploration_id: str. Exploration ID.

        Returns:
            bool. Whether the user is authorized and was able to
                download the given exploration. If that's not the
                case them it returns False.

        Raises:
            PageNotFoundException: The exploration page is not
                found.
        """
        if exploration_id in feconf.DISABLED_EXPLORATION_IDS:
...
def can_access_admin_page(handler):
    ...
    def test_super_admin(self, **kwargs):
        ...
        Returns:
            bool. Whether user is super admin.
...
def can_upload_exploration(handler):
    ...
    def test_can_upload(self, **kwargs):
        ...
        Returns:
            bool. Whether teh user can upload exploration.
...
def can_comment_on_feedback_thread(handler):
    ...
    def test_can_access(self, exploration_id, **kwargs):
        """Check whether the user can view feedback for a given
        exploration.
...
def can_rate_exploration(handler):
    ...
    def test_can_rate(self, exploration_id, **kwargs):
        ...
        Raises:
            UnauthorisedUserException: The user is not authenticate to
                perform current action.
        """
...
def can_flag_exploration(handler):
    ...
    def test_can_flag(self, exploration_id, **kwargs):
        """Check whether user can flag given exploration.
...
def can_subscribe_to_users(handler):
    ...
    def test_can_subscribe(self, **kwargs):
        """Check whether user can subscribe/unsubscribe a creator.
...
def can_edit_exploration(handler):
    ...
    def test_can_edit(self, exploration_id, **kwargs):
        ...
        Returns:
            bool. Whether the user is able to edit any given exploraton.
...
def can_delete_exploration(handler):
    ...
    def test_can_delete(self, exploration_id, **kwargs):
        """Check whether user can delete exploration.
...
def can_publish_exploration(handler):
    ...
    def test_can_publish(self, exploration_id, *args, **kwargs):
        """Check whether user can publish exploration.
...
def can_publish_collection(handler):
    ...
    def test_can_publish_collection(self, collection_id, **kwargs):
        """Check whether user can publish collection.
...
def can_unpublish_collection(handler):
    ...
    def test_can_unpublish_collection(self, collection_id, **kwargs):
        """Check whether user can unpublish collection.

        Args:
            collection_id: str. Collection ID.

        Returns:
            bool. Whether the user can unpublish collection.
